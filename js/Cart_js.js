...
function increment7() {
    ...
    input.value = value + 1;
    let price_of_product7=65000;
    var Total_Price_product7=price_of_product7*(value+1);
    document.getElementById("price_product7").innerHTML = "Rs. "+Total_Price_product7;
    return value;
  }
  ...
  function increment1() {
    ...
    var value = parseInt(input.value);
    input.value = value + 1;
    let price_of_product1=52800;
    Total_Price_product1=price_of_product1*(value+1);
    document.getElementById("price_product1").innerHTML = "Rs. "+Total_Price_product1;
  ...
  function increment2() {
    ...
    var value = parseInt(input.value);
    input.value = value + 1;
    let price_of_product2=114850;
     Total_Price_product2=price_of_product2*(value+1);
    document.getElementById("price_product2").innerHTML = "Rs. "+Total_Price_product2;
  ...
  function increment3() {
    ...
    var value = parseInt(input.value);
    input.value = value + 1;
    let price_of_product3=8500;
    Total_Price_product3=price_of_product3*(value+1);
    document.getElementById("price_product3").innerHTML = "Rs. "+Total_Price_product3;
  }
  ...
  function increment4() {
    ...
    var value = parseInt(input.value);
    input.value = value + 1;
    let price_of_product4=88000;
    Total_Price_product4=price_of_product4*(value+1);
    document.getElementById("price_product4").innerHTML = "Rs. "+Total_Price_product4;
  }
  ...
  function increment5() {
    ...
    var value = parseInt(input.value);
    input.value = value + 1;
    let price_of_product5=122000;
    Total_Price_product5=price_of_product5*(value+1);
    document.getElementById("price_product5").innerHTML = "Rs. "+Total_Price_product5;
  }
  ...
  function increment6() {
    ...
    var value = parseInt(input.value);
    input.value = value + 1;
    let price_of_product6=16600;
    Total_Price_product6=price_of_product6*(value+1);
    document.getElementById("price_product6").innerHTML = "Rs. "+Total_Price_product6;
  }
  ...
  function increment8() {
    ...
    var value = parseInt(input.value);
    input.value = value + 1;
    let price_of_product8=62000;
    Total_Price_product8=price_of_product8*(value+1);
    document.getElementById("price_product8").innerHTML = "Rs. "+Total_Price_product8;
  }
  ...
  function Adding_to_cart1() {
    ...
    if (product_bought1==false) {
      id.push(product_id1);
      let Total_Price_product1 =52800 * parseInt(document.getElementsByClassName("cart-input1")[0].value);
      ...
      document.getElementById("item_1").innerHTML ="Sony XP700 Portable Wireless Speaker";
      document.getElementById("price_1").innerHTML ="Rs. " + Total_Price_product1;
      document.getElementById("Total_price").innerHTML = "Rs. " + Total;
  ...
  function Adding_to_cart2(){
    ...
    if (product_bought2==false) {
      id.push(product_id2);
      let Total_Price_product2 = 114850 * parseInt(document.getElementsByClassName("cart-input2")[0].value);
      console.log(Total_Price_product2);
      Total=Total+Total_Price_product2;
      //perform other operations using Total_Price_product2
      alert("Item succesfully added to the cart!")
      document.getElementById("item_2").innerHTML="Casio High Grade Keyboard CTK-7200";
      document.getElementById("price_2").innerHTML="Rs. "+ Total_Price_product2;
      document.getElementById("Total_price").innerHTML="Rs. "+ Total;
  ...
  function Adding_to_cart3(){
    ...
    if (product_bought3==false) {
      id.push(product_id3);
      let Total_Price_product3 = 8500 * parseInt(document.getElementsByClassName("cart-input3")[0].value);
      console.log(Total_Price_product3);
      Total=Total+Total_Price_product3;
      //perform other operations using Total_Price_product3
      alert("Item succesfully added to the cart!")
      document.getElementById("item_3").innerHTML="Yamaha Guitar F310";
      document.getElementById("price_3").innerHTML="Rs. "+ Total_Price_product3;
      document.getElementById("Total_price").innerHTML="Rs. "+Total;
  ...
  function Adding_to_cart4(){
    ...
    if (product_bought4==false) {
      id.push(product_id4);
      let Total_Price_product4 = 88000 * parseInt(document.getElementsByClassName("cart-input4")[0].value);
      console.log(Total_Price_product4);
      Total=Total+Total_Price_product4;
      //perform other operations using Total_Price_product4
      alert("Item succesfully added to the cart!")
      document.getElementById("item_4").innerHTML="Yamaha Portable Keyboard PSR-E463";
      document.getElementById("price_4").innerHTML="Rs. "+ Total_Price_product4;
      document.getElementById("Total_price").innerHTML="Rs. "+ Total;
  ...
  function Adding_to_cart5(){
    ...
    if (product_bought5==false) {
      id.push(product_id5);
      let Total_Price_product5 = 122000 * parseInt(document.getElementsByClassName("cart-input5")[0].value);
      console.log(Total_Price_product5);
      Total=Total+Total_Price_product5;
      //perform other operations using Total_Price_product5
      alert("Item succesfully added to the cart!")
      document.getElementById("item_5").innerHTML="Yamaha DTX452K Electric Drumkit";
      document.getElementById("price_5").innerHTML="Rs. "+ Total_Price_product5;
      document.getElementById("Total_price").innerHTML="Rs. "+ Total;
  ...
  function Adding_to_cart6(){
    ...
    if (product_bought6==false) {
      id.push(product_id6);
      let Total_Price_product6 = 16600 * parseInt(document.getElementsByClassName("cart-input6")[0].value);
      console.log(Total_Price_product6);
      Total=Total+Total_Price_product6;
      //perform other operations using Total_Price_product6
      alert("Item succesfully added to the cart!")
      document.getElementById("item_6").innerHTML="Yamaha RH5MA Studio Monitor Headphones";
      document.getElementById("price_6").innerHTML="Rs. "+ Total_Price_product6;
      document.getElementById("Total_price").innerHTML="Rs. "+ Total;
  ...
  function Adding_to_cart7(){
    ...
    if (product_bought7==false) {
      id.push(product_id7);
      let Total_Price_product7 = 65000 * parseInt(document.getElementsByClassName("cart-input7")[0].value);
      console.log(Total_Price_product7);
      Total=Total+Total_Price_product7;
      //perform other operations using Total_Price_product7
      alert("Item succesfully added to the cart!")
      document.getElementById("item_7").innerHTML="Yamaha Electric Acoustc Guitar NTX700N";
      document.getElementById("price_7").innerHTML="Rs. "+Total_Price_product7;
      document.getElementById("Total_price").innerHTML="Rs. "+Total;
  ...
  function Adding_to_cart8(){
    ...
    if (product_bought8==false) {
      id.push(product_id8);
    let Total_Price_product8 = 62000 * parseInt(document.getElementsByClassName("cart-input8")[0].value);
    console.log(Total_Price_product8);
    Total=Total+Total_Price_product8;
    //perform other operations using Total_Price_product8
    alert("Item succesfully added to the cart!")
    document.getElementById("item_8").innerHTML="Yamaha SoundBar With Wireless Sub";
    document.getElementById("price_8").innerHTML="Rs. "+ Total_Price_product8;
    document.getElementById("Total_price").innerHTML="Rs. "+Total;
  ...
  function ClearAll_1() {
    ...
    if (id.includes(product_id1)) {
      ...
      Total = Total - (52800 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
  ...
  function ClearAll_2() {
    ...
    if (id.includes(product_id2)) {
      ...
      Total = Total - (114850 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
  ...
  function ClearAll_3() {
    ...
    if (id.includes(product_id3)) {
      ...
      Total = Total - (8500 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
  ...
  function ClearAll_4() {
    ...
    if (id.includes(product_id4)) {
      ...
      Total = Total - (88000 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
  ...
  function ClearAll_5() {
    ...
    if (id.includes(product_id5)) {
      ...
      Total = Total - (122000 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
  ...
  function ClearAll_6() {
    ...
    if (id.includes(product_id6)) {
      ...
      Total = Total - (16600 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
  ...
  function ClearAll_7() {
    ...
    if (id.includes(product_id7)) {
      ...
      Total = Total - (65000 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
  ...
  function ClearAll_8() {
    ...
    if (id.includes(product_id8)) {
      ...
      Total = Total - (62000 * productQuantity);
      if (Total < 0) {
        Total = 0;
      }
